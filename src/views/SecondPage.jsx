...
export default function SecondPage() {
  ...
  const description = {
    accuracy:
      "Accuracy adalah proporsi dari klasifikasi yang benar. Secara matematis, nilai akurasi didapatkan dengan membagi jumlah pengklasifikasian benar dengan jumlah total klasifikasi.",
    precision:
      "Precision merupakan proporsi dari pengklasifikasian positif yang benar positif. Nilai ini didapatkan dengan membagi jumlah pengklasifikasian positif yang benar dibandingkan total jumlah pengklasifikasian positif.",
    recall:
      "Recall adalah proporsi dari True Positif (benar positif) yang diklasifikasi dengan benar. Metrik ini dihitung dengan membagi jumlah pengklasifikasian positif yang benar dengan total jumlah data bernilai positif.",
    "f1-score":
      "Skor F1 merupakan rata-rata harmonik antara nilai Precision dan Recall. Secara fungsional, metrik ini digunakan untuk mendapatkan keseimbangan antara nilai Precision dan Recall.",
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // tentukan hasil evaluasi model, dan model mana yang menghasilkan nilai paling baik
      evaluasiModel(nb_evaluation, svm_evaluation)
  ...
  const evaluasiModel = (model_1, model_2) => {
    const determineWinner = model_1.accuracy > model_2.accuracy;

    setEvaluasi((prev) => ({
      ...prev,
      winner_name: determineWinner ? model_1.name : model_2.name,
      winner_accuracy: determineWinner ? model_1.accuracy : model_2.accuracy,
      loser_name: determineWinner ? model_2.name : model_1.name,
      loser_accuracy: determineWinner ? model_2.accuracy : model_1.accuracy,
    }));
      ...
      <Box sx={{ p: 4, maxWidth: 400, mx: "auto", textAlign: "center" }}>
        ...
        {file && (
          <Box sx={{ paddingBottom: "20px" }}>
            ...
            <FormControl>
              <InputLabel id="process-type-select-label">
                Preprocessing
              </InputLabel>
              <Select
        ...
        <div>
          <Box p={2}>
              ...
              <Card sx={{ minWidth: 275 }}>
                <CardContent>
                  ...
                  >
                    ...
                    tweet-harvest karya helmi satria. data ini belum
                    terlabelisasi, dan terdiri dari kolom-kolom yang tidak akan
                    dibutuhkan
                  </Typography>
                </CardContent>
                {/* <CardActions>
              ...
              <Card sx={{ minWidth: 275 }}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ maxWidth: "1000px", color: "text.secondary" }}
                  >
                    membersihkan teks dari artefak dan karakter-karakter yang
                    bukan huruf abjad
                  </Typography>
                </CardContent>
                {/* <CardActions>
              ...
              <Card sx={{ minWidth: 275 }}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ maxWidth: "1000px", color: "text.secondary" }}
                  >
                    mengkonversi teks tidak baku seperti singkatan, slang, dan
                    typo ke bentuk yang baku
                  </Typography>
                </CardContent>
                {/* <CardActions>
              <Button size="small">Learn More</Button>
              ...
              <Card sx={{ minWidth: 275 }}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ maxWidth: "1000px", color: "text.secondary" }}
                  >
                    menghapus kata-kata yang tidak mengandung nilai sentimen
                    tinggi
                  </Typography>
                </CardContent>
                {/* <CardActions>
            ...
            <Paper elevation={4} sx={{ mb: 4 }}>
              <CustomizedTables
                data={classification}
                headers={["text", "true_label", "pred_nb", "pred_svm"]}
              />
            </Paper>
            <Paper elevation={4} sx={{ mb: 4 }}>
              <Card sx={{ minWidth: 275 }}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ maxWidth: "1000px", color: "text.secondary" }}
                  >
                    perbandingan hasil klasifikasi antara naive bayes dan
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  <DropdownCard
                    title="Accuracy"
                    desc={description["accuracy"]}
                    score={evalNB ? evalNB.accuracy.toFixed(2) : null}
                  />
                </Box>
              </Box>
              ...
              >
                <DropdownCard
                  title="Precision"
                  desc={description["precision"]}
                  score={evalNB.classification_report[
                    "weighted avg"
                  ].precision.toFixed(2)}
                />
                <DropdownCard
                  title="Recall"
                  desc={description["recall"]}
                  score={evalNB.classification_report[
                    "weighted avg"
                  ].recall.toFixed(2)}
                />
                <DropdownCard
                  title="F1-Score"
                  desc={description["f1-score"]}
                  score={evalNB.classification_report["weighted avg"][
                    "f1-score"
                  ].toFixed(2)}
                />
              </Box>
              ...
              <Box justifyContent="center" display="flex" alignItems="center">
                ...
                >
                  <DropdownCard
                    ...
                    desc={description["confusion-matrix"]}
                    img={`data:image/png;base64,${confusionMatrixNB}`}
                  />
                </Box>
              </Box>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  <DropdownCard
                    title="Accuracy"
                    desc={description["accuracy"]}
                    score={evalSVM ? evalSVM.accuracy.toFixed(2) : null}
                  />
                </Box>
              </Box>
              {/* Classification Report */}
              ...
              >
                <DropdownCard
                  title="Precision"
                  desc={description["precision"]}
                  score={evalSVM.classification_report[
                    "weighted avg"
                  ].precision.toFixed(2)}
                />
                <DropdownCard
                ...
                <DropdownCard
                  title="F1-Score"
                  desc={description["f1-score"]}
                  score={evalSVM.classification_report["weighted avg"][
                    "f1-score"
                  ].toFixed(2)}
                />
              </Box>
              ...
              <Box justifyContent="center" display="flex" alignItems="center">
                ...
                >
                  <DropdownCard
                    title="Confusion Matrix"
                    desc={description["confusion-matrix"]}
                    img={`data:image/png;base64,${confusionMatrixSVM}`}
                  />
                </Box>
              </Box>
            </Grid>
                ...
                <CardContent>
                  ...
                  >
                    <Typography variant="body1" textAlign="justify">
                      Berdasarkan perbandingan nilai Accuracy hasil kinerja
                      antara model Naive Bayes dan Support Vector Machine,
                      ditemukan bahwa model{" "}
                      <span style={{ fontWeight: "bold" }}>
                        {evaluasi ? evaluasi.winner_name : null}
                      </span>{" "}
                      merupakan model yang lebih unggul dengan nilai Accuracy{" "}
                      <span style={{ fontWeight: "bold" }}>
                        {/* {evalSVM ? evalSVM.accuracy.toFixed(2) : null} */}
                        {evaluasi ? evaluasi.winner_accuracy.toFixed(2) : null}
                      </span>
                      , dibandingkan model{" "}
                      <span style={{ fontWeight: "bold" }}>{evaluasi ? evaluasi.loser_name : null}</span>{" "}
                      dengan nilai Accuracy{" "}
                      <span style={{ fontWeight: "bold" }}>
                        {/* {evalNB ? evalNB.accuracy.toFixed(2) : null} */}
                        {evaluasi ? evaluasi.loser_accuracy.toFixed(2) : null}
                      </span>
                      .
                    </Typography>
                  </Typography>
